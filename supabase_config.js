// ============================================================
//  MORFO PORTAL - Supabase Configuration & Media Resolver
// ============================================================
...
// Toggle para activar la resolución de archivos pesados desde Supabase Storage
...
function sanitizeStorageKey(path) {
    ...
    // Normalizar acentos y caracteres especiales a formato compatible con Supabase S3
    clean = clean.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[^a-zA-Z0-9_\-\.\/ ]/g, "_");
    return clean;
}

/**
 * Resuelve una ruta local de archivo a su URL pública correspondiente en Supabase Storage.
 * @param {string} path - Ruta relativa local (ej. "Bibliografias/medicina interna -harrison 2008- vol 1.pdf")
 * @returns {string} - URL pública de Supabase o ruta original
 */
